    ...
    <div id="view-daily" className="view active">
      ...
      {isWork ? (
        <>
          ...
          <div style={{ fontSize: '13px', fontWeight: 600, color: 'var(--muted)', textAlign: 'center', padding: '4px 0 2px', letterSpacing: '0.3px', opacity: 0.75 }}>
            +1 รอบ จะเพิ่มจุดอัตโนมัติ หากมีจุดเพิ่ม ให้เพิ่มจุดเอง
          </div>
          {/* Rounds & Points Card */}
          ...
          <div style={{ fontSize: '13px', fontWeight: 600, color: 'var(--muted)', textAlign: 'center', padding: '6px 0 2px', letterSpacing: '0.3px', opacity: 0.75 }}>
            การเพิ่ม งานช่วย/แก้ จะรวมผลให้อัตโนมัติ
          </div>
