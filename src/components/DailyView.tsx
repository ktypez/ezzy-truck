  ...
  return (
    <div id="view-daily" className="view active">
      ...
      {isWork ? (
        <>
          {/* Summary Banner */}
          <div className="daily-summary" style={{ display: 'flex', justifyContent: 'space-around', background: 'var(--primary-bg)', borderRadius: '14px', padding: 'var(--space-md)', marginBottom: 'var(--space-lg)', border: '1px solid var(--border)', boxShadow: '0 2px 8px rgba(0,0,0,0.09)' }}>
        ...
        <div className="card" style={{ textAlign: 'center', padding: 'var(--space-3xl) var(--space-xl)' }}>
          ...
          <h3 style={{ fontSize: '20px', fontWeight: 800, color: leaveType === 'sick' ? '#3498db' : leaveType === 'personal' ? '#3498db' : 'var(--primary)', marginBottom: '4px' }}>
