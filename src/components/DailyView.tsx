  ...
  return (
    <div id="view-daily" className="view active">
      ...
      {isWork ? (
        <>
          {/* Summary Banner */}
          <div className="daily-summary" style={{ display: 'flex', justifyContent: 'space-around', background: 'var(--primary-bg)', borderRadius: '14px', padding: '12px', marginBottom: '12px', border: '1px solid var(--border)', boxShadow: '0 2px 8px rgba(0,0,0,0.09)' }}>
          ...
          <div style={{ background: 'var(--primary-bg)', borderRadius: '12px', padding: '10px 14px', marginBottom: '8px', border: '1px solid var(--border)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', fontWeight: 600, color: 'var(--muted)', lineHeight: 1.6 }}>
              <span style={{ background: 'var(--primary)', color: 'var(--active-date-text, white)', borderRadius: '50%', width: '20px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', flexShrink: 0, boxShadow: '0 2px 6px rgba(0,0,0,0.18)' }}>i</span>
