  ...
  return (
    <div id="view-daily" className="view active">
      ...
      {isWork ? (
        <>
          {/* Summary Banner */}
          <div className="daily-summary" style={{ display: 'flex', justifyContent: 'space-around', background: 'var(--primary-bg)', borderRadius: '14px', padding: 'var(--space-md)', marginBottom: 'var(--space-md)', border: '1px solid var(--border)', boxShadow: '0 2px 8px rgba(0,0,0,0.09)' }}>
          ...
          <div style={{ background: 'var(--primary-bg)', borderRadius: '12px', padding: 'var(--space-sm) var(--space-md)', marginBottom: 'var(--space-sm)', border: '1px solid var(--border)', boxShadow: '0 2px 8px rgba(0,0,0,0.09)' }}>
