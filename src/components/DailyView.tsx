    ...
    <div id="view-daily" className="view active">
      ...
      {isWork ? (
        <>
          ...
          <div style={{ background: 'var(--primary-bg)', borderRadius: '12px', padding: '10px 14px', marginBottom: '8px', border: '1px solid var(--border)', boxShadow: '0 2px 8px rgba(0,0,0,0.09)' }}>
