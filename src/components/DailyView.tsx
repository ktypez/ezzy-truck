...
const months = ["มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายน", "กรกฎาคม", "สิงหาคม", "กันยายน", "ตุลาคม", "พฤศจิกายน", "ธันวาคม"];
  ...
  return (
    <div id="view-daily" className="view active">
      ...
      <div style={{ display: 'flex', gap: 'var(--space-sm)', marginBottom: 'var(--space-lg)', marginTop: 'var(--space-sm)', alignItems: 'center' }}>
        ...
        <>
          ...
          <div style={{ background: 'var(--primary-bg)', borderRadius: '12px', padding: 'var(--space-sm) var(--space-md)', marginBottom: 'var(--space-md)', border: '1px solid var(--border)', boxShadow: '0 2px 8px rgba(0,0,0,0.09)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-sm)', fontSize: '13px', fontWeight: 600, color: 'var(--muted)', lineHeight: 1.6 }}>
              ...
              <span>➕ รอบ = จุดอัตโนมัติ · งานช่วย/แก้ รวมในรอบ-จุด</span>
            </div>
          </div>
          {/* Rounds & Points Card */}
