  ...
  return (
    <div id="auth-screen">
      <div className="auth-card">
        ...
        >
          <i
            className="ph-duotone ph-truck i-icon"
        ...
        >
          {loading ? (
            <>
              <i
                className="ph-duotone ph-spinner-gap spin i-icon"
            ...
            <>
              <i className="ph-duotone ph-sign-in i-icon" style={{ marginRight: '10px' }}></i>{' '}
              เข้าสู่ระบบทันที
            </>
          )}
        </button>
        ...
        >
          ...
          >
            🔒 ระบบปิดสำหรับพนักงานขับรถ Ezzy Truck เท่านั้น
            <br />
