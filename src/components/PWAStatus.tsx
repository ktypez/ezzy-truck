...
export default function PWAStatus() {
    ...
    const fallbackTimer = setTimeout(() => {
      if (!deferredPrompt && !isInstalled()) {
        const dismissed = localStorage.getItem(
          isIOS() ? 'pwa-dismissed-ios' : 'pwa-dismissed-other',
        )
        if (!dismissed) setShowInstallBanner(true)
      }
    }, 3000)
  ...
  return (
    <>
      {isOffline && <div id="offline-toast">📡 ออฟไลน์ — บางฟีเจอร์อาจไม่พร้อมใช้งาน</div>}
        ...
        <div id="install-banner">
          ...
          <div className="banner-text">
            ...
            {deferredPrompt ? (
              ...
              <span>
                กดแชร์ <span className="ios-share-icon">⎋</span> แล้วเลือก
                &ldquo;เพิ่มที่หน้าจอโฮม&rdquo;
              </span>
            ) : (
